  ...
  /* VRes = V1 + V2 */
{
  ...
  if (LASResult() == LASOK) {
    if (V1->Dim == V2->Dim) {
      ...
      VResName = (char *)malloc((strlen(V_GetName(V1)) + strlen(V_GetName(V2)) + 4)
                                * sizeof(char));
  ...
  if (LASResult() == LASOK) {
    if (Q1->Dim == Q2->Dim) {
      if (Q1->Symmetry == Q2->Symmetry &&
        ...
        QResName = (char *)malloc((strlen(Q_GetName(Q1)) + strlen(Q_GetName(Q2)) + 4)
                                  * sizeof(char));
  ...
  if (LASResult() == LASOK) {
    if (Q1->Dim == Q2->Dim) {
      if (Q1->Symmetry == Q2->Symmetry &&
          ...
          Q1->El == Q2->El) {
        QRes = (QMatrix *)malloc(sizeof(QMatrix));
        QResName = (char *)malloc((strlen(Q_GetName(Q1)) + strlen(Q_GetName(Q1)) + 4)
                                  * sizeof(char));
        if (QRes != NULL && QResName != NULL) {
          sprintf(QResName, "%s - %s", Q_GetName(Q1), Q_GetName(Q2));
          Q_Constr(QRes, QResName, Q1->Dim, Q1->Symmetry, Q1->ElOrder, Tempor, False);
  ...
  /* VRes = M * V */
{
  ...
  if (LASResult() == LASOK) {
    if (M->ClmDim == V->Dim) {
      ...
      ClmDim = M->ClmDim;
      VRes = (Vector *)malloc(sizeof(Vector));
      VResName = (char *)malloc((strlen(M_GetName(M)) + strlen(V_GetName(V)) + 8)
                                * sizeof(char));
      if (VRes != NULL && VResName != NULL) {
  ...
  /* VRes = Q * V */
{
  ...
  if (LASResult() == LASOK) {
    if (Q->Dim == V->Dim) {
      Dim = V->Dim;
      VRes = (Vector *)malloc(sizeof(Vector));
      VResName = (char *)malloc((strlen(Q_GetName(Q)) + strlen(V_GetName(V)) + 8)
                                * sizeof(char));
      if (VRes != NULL && VResName != NULL) {
