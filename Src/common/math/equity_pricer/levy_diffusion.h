#ifndef __levy_diffusion__
#define __levy_diffusion__
...
extern void Heston_diffusion_list(const Heston_diffusion * process);
...
extern void BNS_diffusion_list(const BNS_diffusion * process);
...
extern void DPS_diffusion_list(const DPS_diffusion * model);
...
extern void CIR_diffusion_list(const CIR_diffusion * process);
...
extern void CIR_diffusion_update_time(CIR_diffusion *  process,double t);
/*
...
extern void GammaOU_diffusion_update_time(GammaOU_diffusion * process,double t);
extern void GammaOU_diffusion_list(const GammaOU_diffusion * process);
...
extern Levy_diffusion * Levy_diffusion_create_from_vect(int model,const double * input);
extern void Levy_diffusion_free(Levy_diffusion ** Levy);
...
extern dcomplex Levy_diffusion_ln_characteristic_function(dcomplex u,double t,Levy_diffusion * mod);
extern dcomplex Levy_diffusion_ln_characteristic_function_with_cast(dcomplex u,double t,void * mod);
//extern dcomplex Levy_diffusion_characteristic_function(dcomplex u,double t,Levy_diffusion * mod);

extern void Levy_diffusion_constraints(PnlVect *res, const Levy_diffusion * Levy);
