...
extern void Constraints_ForLevyProcess(PnlVect *res, const PnlVect *x, void *data);

extern double QuadraticError_ForLevyDiffusion(const PnlVect *GenerationParams,void *data);
extern void Constraints_ForLevyDiffusion(PnlVect *res, const PnlVect *x, void *data);
