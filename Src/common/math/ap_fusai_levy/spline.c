...
int smooth(long ntab, double x[], double f[], double **c, int np, double xp[], double fp[])
{
	int i,ier;
	double dx,dfb,ddfb;
...
int smoothmod(long ntab, double x[], double f[], double **c, int np, double xp[], double fp[])
{
	int i,ier;
	double dfb,ddfb;
