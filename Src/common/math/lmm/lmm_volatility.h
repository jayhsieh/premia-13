...
extern int mallocVolatility(Volatility** ptVol , int numOfFac,double sigma);
...
extern int mallocVolatilityInteger(Volatility **ptVol , int numOfFac, float  tenor, double sigma);
extern void freeVolatility(Volatility **ptVol);
#endif
