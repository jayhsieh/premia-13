...
static TYPEOPT CallableInverseFloater=
{
    ...
    {"Strike",PDOUBLE,{0},ALLOW,SETABLE},      /* Strike;*/
    {"Gearing",PDOUBLE,{0},ALLOW,SETABLE},     /* Gearing;*/
...
MAKEOPT(CallableInverseFloater);
