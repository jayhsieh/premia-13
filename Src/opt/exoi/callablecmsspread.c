...
static TYPEOPT CallableCMSSpread=
{
    ...
    {"Floor Rate",PDOUBLE,{0},ALLOW,SETABLE},      /* Floor;*/
    ...
    {"CMS1 Maturity",PDOUBLE,{0},ALLOW,SETABLE},      /* CMSMat1;*/
    {"CMS2 Maturity",PDOUBLE,{0},ALLOW,SETABLE},      /* CMSMat2;*/
};
...
static int OPT(Init)(Option *opt,Model *mod)
{
    ...
    if ( opt->init == 0)
    {
        ...
        (pt->Nominal).Val.V_PDOUBLE=10000.0;
        (pt->Spread).Val.V_PDOUBLE=0.05;
        (pt->Cap).Val.V_PDOUBLE=0.06;
