...
static TYPEOPT ParisianCallUpOutEuro=
  {
    ...
    /*DownOrUp*/    {"Up",BOOL,{DOWN},FORBID,UNSETABLE},
  ...
  if ( opt->init == 0) 
    {
      ...
      (pt->Limit.Val.V_NUMFUNC_1)->Par[3].Val.V_PDOUBLE=110.0;
