...
static double phi(ZCMarketData* ZCMarket, double r, double periodicity, double option_maturity, double contract_maturity,
  ...
  for(i=1; i<=nb_payement; i++)
    {
      ...
      PutOptionPrice = cf_hw1d_zbput(&ZCMarket, a, sigma, ti, option_maturity, Strike_i);
