...
int CALC(CF_AttariBNS)(void *Opt, void *Mod, PricingMethod *Met)
{
...
static int CHK_OPT(CF_AttariBNS)(void *Opt, void *Mod)
{ 
...
PricingMethod MET(CF_AttariBNS)=
{
  "CF_Attari_BNS",
