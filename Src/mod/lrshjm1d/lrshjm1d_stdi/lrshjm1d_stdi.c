...
extern PricingMethod MET(TR_ZCBondLRS1D);
extern PricingMethod MET(TR_ZBOLRS1D);
extern PricingMethod MET(TR_CapFloorLRS1D);
extern PricingMethod MET(TR_SwaptionLRS1D);

PricingMethod* MOD_OPT(methods)[]={
  &MET(TR_ZCBondLRS1D),
  &MET(TR_ZBOLRS1D),
  &MET(TR_CapFloorLRS1D),
  &MET(TR_SwaptionLRS1D),
  NULL
};
