...
extern PricingMethod MET(CF_LibAffGou1d_Fourier_CapFloor);
extern PricingMethod MET(CF_LibAffGou1d_Fourier_Swaption);

PricingMethod* MOD_OPT(methods)[]={
  &MET(CF_LibAffGou1d_Fourier_CapFloor),
  &MET(CF_LibAffGou1d_Fourier_Swaption),
  NULL
};
