...
static int zcb_vasicek(long Nt,int NtO,double K,double periodicity,double first_payement,int nb_coupon)
{
  int i,j,z;
...
static int swaption_vasicek1d(double r0,double k,double t0, double sigma,double theta,double T,double t,NumFunc_1 *p,int am,double Nominal,double K,double periodicity,long NtY,double *price)
{
  ...
  zcb_vasicek(Nt,NtO,K,periodicity,first_payement,nb_coupon);
