...
static int capfloor_vasicek1d(double r0,double k,double t0, double sigma,double theta,double first_payement,double Nominal,double K,double periodicity,NumFunc_1 *p,double T,long NtY,double *price)
{
...
int CALC(FD_CAPFLOOR)(void *Opt,void *Mod,PricingMethod *Met)
{
  ...
  return capfloor_vasicek1d(ptMod->r0.Val.V_PDOUBLE,ptMod->k.Val.V_DOUBLE,ptMod->T.Val.V_DATE,ptMod->Sigma.Val.V_PDOUBLE,
...
{
  "FD_Explicit_Vasicek1d_CapFloor",
