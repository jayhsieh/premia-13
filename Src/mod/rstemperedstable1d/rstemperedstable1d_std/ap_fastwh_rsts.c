...
//===================================================================================
int CALC(AP_fastwhamer_rstemperedstable)(void *Opt,void *Mod,PricingMethod *Met)
{
  ...
  res = wh_rstemperedstable_amerput(ifCall, spot,
...
static int CHK_OPT(AP_fastwhamer_rstemperedstable)(void *Opt, void *Mod)
{
...
PricingMethod MET(AP_fastwhamer_rstemperedstable)=
{
  "AP_FastWH_RSTS",
