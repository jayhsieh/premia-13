  ...
  if (model->init == 0 )
    {
      ...
      sprintf( pt->Transition_probabilities.Val.V_FILENAME, "%s%sTEMPEREDSTABLE_Transition_probabilities.dat", premia_data_dir,path_sep);
...
TYPEMOD RSTemperedstable1dim;

MAKEMOD(RSTemperedstable1dim);
