...
int CALC(MC_LongstaffSchwartz_CallableInverseFloater)(void *Opt, void *Mod, PricingMethod *Met)
{
  ...
  return MC_CIF_LongstaffSchwartz(   ptMod->l0.Val.V_PDOUBLE,
                                     ...
                                     ptOpt->Strike.Val.V_PDOUBLE,
                                     ptOpt->Gearing.Val.V_PDOUBLE,
...
static int CHK_OPT(MC_LongstaffSchwartz_CallableInverseFloater)(void *Opt, void *Mod)
{
  if ((strcmp(((Option*)Opt)->Name,"CallableInverseFloater")==0))
    return OK;
  else
    return WRONG;
}
...
PricingMethod MET(MC_LongstaffSchwartz_CallableInverseFloater)=
{
  "MC_LongstaffSchwartz_Callable_Inverse_Floater",
  {
  ...
  CALC(MC_LongstaffSchwartz_CallableInverseFloater),
  {   {"Price",DOUBLE,{100},FORBID},
      {" ",PREMIA_NULLTYPE,{0},FORBID}},
  CHK_OPT(MC_LongstaffSchwartz_CallableInverseFloater),
  CHK_ok,
  MET(Init)
};
