...
int MCAlfonsiOut(int upordown,double S0, NumFunc_1  *p, double limit, double rebate,double t, double r, double divid, double V0,double k,double theta,double sigma,double rho, long nb, int M,int generator, double confidence,int flag_cir,  double increment,double *ptprice, double *ptdelta, double *pterror_price, double *pterror_delta , double *inf_price, double *sup_price, double *inf_delta, double *sup_delta)
{
  ...
  double lnspot,lnspot_increment=0.,barrier,curr_time;
...
int CALC(MC_Alfonsi_HestonOut)(void *Opt, void *Mod, PricingMethod *Met)
{
  ...
  return MCAlfonsiOut(upordown,ptMod->S0.Val.V_PDOUBLE,
...
static int CHK_OPT(MC_Alfonsi_HestonOut)(void *Opt, void *Mod)
{
...
PricingMethod MET(MC_Alfonsi_HestonOut)=
{
  "MC_Alfonsi_Out",
