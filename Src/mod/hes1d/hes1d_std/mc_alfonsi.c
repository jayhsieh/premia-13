...
int CALC(MC_Alfonsi_Heston)(void *Opt, void *Mod, PricingMethod *Met)
{
  ...
  return MCAlfonsi(ptMod->S0.Val.V_PDOUBLE,
...
static int CHK_OPT(MC_Alfonsi_Heston)(void *Opt, void *Mod)
{
...
PricingMethod MET(MC_Alfonsi_Heston)=
{
  "MC_Alfonsi",
