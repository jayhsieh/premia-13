...
int CALC(CF_AttariHeston)(void *Opt, void *Mod, PricingMethod *Met)
{
...
static int CHK_OPT(CF_AttariHeston)(void *Opt, void *Mod)
{ 
...
PricingMethod MET(CF_AttariHeston)=
{
  "CF_Attari_Heston",
  {{" ",PREMIA_NULLTYPE,{0},FORBID}},
  CALC(CF_AttariHeston),
  {{"Price",DOUBLE,{100},FORBID},
   {"Delta",DOUBLE,{100},FORBID} ,
   {" ",PREMIA_NULLTYPE,{0},FORBID}},
  CHK_OPT(CF_AttariHeston),
  CHK_ok,
  MET(Init)
};
