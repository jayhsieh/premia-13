...
static int Psor(double s,NumFunc_1  *p,double t,double r,double divid,double sigma,
                int N,int M,double theta,double omega,double epsilon,double *ptprice,double *ptdelta)
{
...
int CALC(FD_Psor)(void *Opt,void *Mod,PricingMethod *Met)
{
  ...
  return Psor(ptMod->S0.Val.V_PDOUBLE,ptOpt->PayOff.Val.V_NUMFUNC_1,
