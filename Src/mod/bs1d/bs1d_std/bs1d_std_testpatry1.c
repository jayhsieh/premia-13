...
int CALC(DynamicHedgingSimulatorPatry1)(void *Opt,void *Mod,PricingMethod *Met,DynamicTest *Test)
{
...
int CHK_TEST(testpatry1)(void *Opt, void *Mod, PricingMethod *Met)
{
