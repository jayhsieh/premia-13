...
/* 2-points Bunch-Johnsonn AP*/
static int BunchJohnsonn_92(double s,NumFunc_1*p,double t,double r,double divid,double sigma,double *ptprice,double *ptdelta)
...
int CALC(AP_BunchJohnsonn)(void *Opt,void *Mod,PricingMethod *Met)
{
...
PricingMethod MET(AP_BunchJohnsonn)=
{
  ...
  CALC(AP_BunchJohnsonn),
  {{"Price",DOUBLE,{100},FORBID},{"Delta",DOUBLE,{100},FORBID} ,{" ",PREMIA_NULLTYPE,{0},FORBID}},
  CHK_OPT(AP_BunchJohnsonn),
  CHK_ok ,
  MET(Init)
} ;
