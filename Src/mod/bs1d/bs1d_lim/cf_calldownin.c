...
static int CallDownIn_ReinerRubinstein(double s,double k,double l,double rebate,double t,double r,double divid,double sigma,double *ptprice,double *ptdelta)
{
  int phi,eta;
  double A,B,C,D,E,F;
...
int CALC(CF_CallDownIn)(void*Opt,void *Mod,PricingMethod *Met)
{
  ...
  return CallDownIn_ReinerRubinstein(ptMod->S0.Val.V_PDOUBLE,(ptOpt->PayOff.Val.V_NUMFUNC_1)->Par[0].Val.V_PDOUBLE,
