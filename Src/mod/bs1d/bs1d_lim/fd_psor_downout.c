...
int CALC(FD_Psor_DownOut)(void *Opt,void *Mod,PricingMethod *Met)
{
  ...
  return Psor_DownOut(ptMod->S0.Val.V_PDOUBLE,ptOpt->PayOff.Val.V_NUMFUNC_1,limit,rebate,
                      ptOpt->Maturity.Val.V_DATE-ptMod->T.Val.V_DATE,r,divid,ptMod->Sigma.Val.V_PDOUBLE,
                      Met->Par[0].Val.V_INT2,Met->Par[1].Val.V_INT2, Met->Par[2].Val.V_RGDOUBLE051,Met->Par[3].Val.V_RGDOUBLE12,Met->Par[4].Val.V_RGDOUBLE,
                      &(Met->Res[0].Val.V_DOUBLE),&(Met->Res[1].Val.V_DOUBLE));
}

static int CHK_OPT(FD_Psor_DownOut)(void *Opt, void *Mod)
{
...
PricingMethod MET(FD_Psor_DownOut)=
{
  "FD_Psor_DownOut",
  ...
  CALC(FD_Psor_DownOut),
  {{"Price",DOUBLE,{100},FORBID},{"Delta",DOUBLE,{100},FORBID} ,{" ",PREMIA_NULLTYPE,{0},FORBID}},
  CHK_OPT(FD_Psor_DownOut),
  CHK_psor,
  MET(Init)
};
