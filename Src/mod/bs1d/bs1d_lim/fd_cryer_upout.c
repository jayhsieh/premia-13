...
static int Cryer_UpOut(double s,NumFunc_1  *p,double l,double rebate,double t,double r,double divid,double sigma,int N,int M,double *ptprice,double *ptdelta)
{
  int      Index,PriceIndex,TimeIndex,ssl;
  double   k,vv,loc,h,z,alpha,beta,gamma,y,up,upwind_alphacoef;
...
int CALC(FD_Cryer_UpOut)(void *Opt,void *Mod,PricingMethod *Met)
{
  ...
  return Cryer_UpOut(ptMod->S0.Val.V_PDOUBLE,ptOpt->PayOff.Val.V_NUMFUNC_1,
...
static int CHK_OPT(FD_Cryer_UpOut)(void *Opt, void *Mod)
{
...
PricingMethod MET(FD_Cryer_UpOut)=
{
  "FD_Cryer_UpOut",
