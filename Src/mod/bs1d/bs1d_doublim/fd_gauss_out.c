...
static int Gauss_Out(int am,double s,NumFunc_1  *L, NumFunc_1  *U,NumFunc_1  *Rebate,NumFunc_1  *p,double t,double r,double divid,double sigma,int N,int M,double theta,double *ptprice,double *ptdelta)
{
...
int CALC(FD_Gauss_Out)(void*Opt,void *Mod,PricingMethod *Met)
{
  ...
  return Gauss_Out(ptOpt->EuOrAm.Val.V_BOOL,ptMod->S0.Val.V_PDOUBLE,
...
static int CHK_OPT(FD_Gauss_Out)(void *Opt, void *Mod)
{
