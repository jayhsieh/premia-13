...
static int Call_KunitomoIkeda_91(double s,NumFunc_1 *L,NumFunc_1 *U,NumFunc_1  *Rebate,NumFunc_1 *PayOff,double t,double r,double divid,double sigma,double *ptprice,double *ptdelta){
...
int CALC(CF_CallOut_KunitomoIkeda)(void*Opt,void *Mod,PricingMethod *Met)
{
  ...
  return  Call_KunitomoIkeda_91(ptMod->S0.Val.V_PDOUBLE,ptOpt->LowerLimit.Val.V_NUMFUNC_1, ptOpt->UpperLimit.Val.V_NUMFUNC_1,
