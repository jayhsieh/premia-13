...
int MOD_OPT(ChkMix)(Option *Opt,Model *Mod)
{
  ...
  if ((strcmp(Opt->Name,"ZeroCouponCallBondEuro")==0) || (strcmp(Opt->Name,"ZeroCouponPutBondEuro")==0) || (strcmp(Opt->Name,"ZeroCouponCallBondAmer")==0) || (strcmp(Opt->Name,"ZeroCouponPutBondAmer")==0)|| (strcmp(Opt->Name,"CouponBearingCallEuro")==0))
    {
...
extern PricingMethod MET(FD_NataliniBrianiAFFINE3D);
 

PricingMethod* MOD_OPT(methods)[]={
    &MET(FD_NataliniBrianiAFFINE3D),
  NULL
};
