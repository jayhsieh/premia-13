...
/*/////////////////////////////////////////////////////*/
static int wh_rskou_amerdigital(double Spot,
...
//===================================================================================
int CALC(AP_fastwhamerdig_rskou)(void *Opt,void *Mod,PricingMethod *Met)
{
...
static int CHK_OPT(AP_fastwhamerdig_rskou)(void *Opt, void *Mod)
{
...
PricingMethod MET(AP_fastwhamerdig_rskou)=
{
  "AP_FastWHDig_RSKOU",
