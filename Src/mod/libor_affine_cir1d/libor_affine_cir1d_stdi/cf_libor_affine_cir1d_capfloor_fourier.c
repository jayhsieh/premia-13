...
static int cf_capfloor_fourier_libaff_cir1d(int InitYieldCurve_flag, double R_flat, char *curve, double x0, double lambda, double theta, double eta, double cap_start, double cap_end, double cap_period, double cap_strike, double cap_nominal, int cap_floor, double *cap_price)
{
...
int CALC(CF_LibAffCir1d_Fourier_CapFloor)(void *Opt,void *Mod,PricingMethod *Met)
{
    ...
    return  cf_capfloor_fourier_libaff_cir1d(   ptMod->flat_flag.Val.V_INT,
                                                MOD(GetYield)(ptMod),
                                                MOD(GetCurve)(ptMod),
...
static int CHK_OPT(CF_LibAffCir1d_Fourier_CapFloor)(void *Opt, void *Mod)
{
...
static int MET(Init)(PricingMethod *Met,Option *Opt)
{
    ...
    {
      Met->init=1;
       Met->HelpFilenameHint = "cf_libor_affine_cir1d_capfloor_fourier";
    }
    return OK;
}


PricingMethod MET(CF_LibAffCir1d_Fourier_CapFloor)=
{
    "CF_LibAffCir1d_Fourier_CapFloor",
    {{" ",PREMIA_NULLTYPE,{0},FORBID}},
    CALC(CF_LibAffCir1d_Fourier_CapFloor),
    {{"Price",DOUBLE,{100},FORBID},{" ",PREMIA_NULLTYPE,{0},FORBID}},
    CHK_OPT(CF_LibAffCir1d_Fourier_CapFloor),
    CHK_ok,
    MET(Init)
} ;
