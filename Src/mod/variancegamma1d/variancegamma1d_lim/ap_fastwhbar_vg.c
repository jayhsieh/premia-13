...
static int wh_vg_downout(int am, int upordown, int ifCall,
                         ...
                         double *ptprice, double *ptdelta)
{
  ...
  fastwienerhopf(3, mu, qu, om, am, upordown, ifCall, Spot, lm1, lp1,
...
//===================================================================================
int CALC(AP_fastwhdownout_vg)(void *Opt,void *Mod,PricingMethod *Met)
{
  ...
  res = wh_vg_downout(ptOpt->EuOrAm.Val.V_BOOL,upordown, ifCall, spot,ptMod->Sigma.Val.V_PDOUBLE,ptMod->Theta.Val.V_PDOUBLE,ptMod->Kappa.Val.V_PDOUBLE,
                      r, divid,
...
static int CHK_OPT(AP_fastwhdownout_vg)(void *Opt, void *Mod)
{
...
PricingMethod MET(AP_fastwhdownout_vg)=
{
  "AP_FastWHBar_VG",
  ...
  CALC(AP_fastwhdownout_vg),
  {{"Price",DOUBLE,{100},FORBID},
      {"Delta",DOUBLE,{100},FORBID},
      {" ",PREMIA_NULLTYPE,{0},FORBID}},
  CHK_OPT(AP_fastwhdownout_vg),
  CHK_split,
  MET(Init)
};
