...
static int backwardfourier_vg_downout(int am, int upordown, int ifCall,
                         double Spot, double sigma,
                         ...
                         double *ptprice, double *ptdelta)
{
  ...
  bi_barr(mu, qu, om, upordown, ifCall, Spot, lm1, lp1,
...
//===================================================================================
int CALC(AP_backwardfourierbar_vg)(void *Opt,void *Mod,PricingMethod *Met)
{
  ...
  res = backwardfourier_vg_downout(ptOpt->EuOrAm.Val.V_BOOL,upordown, ifCall, spot,ptMod->Sigma.Val.V_PDOUBLE,ptMod->Theta.Val.V_PDOUBLE,ptMod->Kappa.Val.V_PDOUBLE,
                      r, divid,
...
static int CHK_OPT(AP_backwardfourierbar_vg)(void *Opt, void *Mod)
{
...
PricingMethod MET(AP_backwardfourierbar_vg)=
{
  "AP_BackwardFourierBar_VG",
  { {"Scale of logprice range", DOUBLE, {100}, ALLOW},
      {"Space Discretization Step",DOUBLE,{500},ALLOW},
      {"TimeStepNumber",INT2,{100},ALLOW},
      {" ",PREMIA_NULLTYPE,{0},FORBID}},
  CALC(AP_backwardfourierbar_vg),
  {{"Price",DOUBLE,{100},FORBID},
      {"Delta",DOUBLE,{100},FORBID},
      {" ",PREMIA_NULLTYPE,{0},FORBID}},
  CHK_OPT(AP_backwardfourierbar_vg),
  CHK_split,
  MET(Init)
};
