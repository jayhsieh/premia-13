...
/*/////////////////////////////////////////////////////*/
 static int wh_vg_amerdigital(double Spot, double sigma,double theta,double kappa,
...
double  ptprice1, ptdelta1, mu, qu, om;
 ...
 double sig2=sigma*sigma;
  ...
  lm1=beta - alfa;
	...
	fastwienerhopf(3, mu, qu, om, 0, upordown, 2, Spot, lm1, lp1,
...
//===================================================================================
int CALC(AP_fastwhamerdig_vg)(void *Opt,void *Mod,PricingMethod *Met)
{
  ...
  res = wh_vg_amerdigital(spot,ptMod->Sigma.Val.V_PDOUBLE,ptMod->Theta.Val.V_DOUBLE,ptMod->Kappa.Val.V_SPDOUBLE,
			  r, divid,
...
static int CHK_OPT(AP_fastwhamerdig_vg)(void *Opt, void *Mod)
{
...
PricingMethod MET(AP_fastwhamerdig_vg)=
{
  "AP_FastWHDig_VG",
  ...
  CALC(AP_fastwhamerdig_vg),
  {{"Price",DOUBLE,{100},FORBID},
   {"Delta",DOUBLE,{100},FORBID},
   {" ",PREMIA_NULLTYPE,{0},FORBID}},
  CHK_OPT(AP_fastwhamerdig_vg),
  CHK_split,
  MET(Init)
};
