...
/*/////////////////////////////////////////////////////*/
  static int backwardfourier_vg_american(int ifCall, double Spot,double sigma,double theta,double kappa,
...
int CALC(AP_backwardfourieramer_vg)(void *Opt,void *Mod,PricingMethod *Met)
{
  ...
  res = backwardfourier_vg_american(ifCall, spot,ptMod->Sigma.Val.V_PDOUBLE,ptMod->Theta.Val.V_DOUBLE,ptMod->Kappa.Val.V_SPDOUBLE, 
    r, divid,
