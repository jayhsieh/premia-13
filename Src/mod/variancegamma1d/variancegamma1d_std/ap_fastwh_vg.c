...
/*/////////////////////////////////////////////////////*/
  static int wh_vg_american(int ifCall, double Spot,double sigma,double theta,double kappa,
...
double  ptprice1, ptdelta1, mu, qu, om;
 ...
 double sig2=sigma*sigma;
  ...
  lm1=beta - alfa;
	...
	fastwienerhopfamerican(3, mu, qu, om, ifCall, Spot, lm1, lp1,
...
//===================================================================================
int CALC(AP_fastwhamer_vg)(void *Opt,void *Mod,PricingMethod *Met)
{
  ...
  res = wh_vg_american(ifCall, spot,ptMod->Sigma.Val.V_PDOUBLE,ptMod->Theta.Val.V_DOUBLE,ptMod->Kappa.Val.V_SPDOUBLE, 
    r, divid,
...
static int CHK_OPT(AP_fastwhamer_vg)(void *Opt, void *Mod)
{
...
PricingMethod MET(AP_fastwhamer_vg)=
{
  "AP_FastWH_VG",
  ...
  CALC(AP_fastwhamer_vg),
  {{"Price",DOUBLE,{100},FORBID},
   {"Delta",DOUBLE,{100},FORBID},
   {" ",PREMIA_NULLTYPE,{0},FORBID}},
  CHK_OPT(AP_fastwhamer_vg),
  CHK_split,
  MET(Init)
};
