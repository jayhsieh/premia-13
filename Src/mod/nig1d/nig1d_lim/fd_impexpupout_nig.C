...
static int ImpExpUpOut(int am,double S0,NumFunc_1  *p,double l_up,double rebate,double T,double r,double divid,double sigma,double theta,double kappa,double dx,int M,int flag_scheme,double *ptprice,double *ptdelta)
{
...
static int MET(Init)(PricingMethod *Met,Option *Opt)
{
  ...
  if (first) 
    {
      Met->HelpFilenameHint = "FD_ImpExpupout_nig";
