...
int CALC(CF_CarrMertonHeston)(void *Opt, void *Mod, PricingMethod *Met)
{
...
static int CHK_OPT(CF_CarrMertonHeston)(void *Opt, void *Mod)
{ 
...
PricingMethod MET(CF_CarrMertonHeston)=
{
  "CF_Carr_MertonHeston",
  {{" ",PREMIA_NULLTYPE,{0},FORBID}},
  CALC(CF_CarrMertonHeston),
  {{"Price",DOUBLE,{100},FORBID},
   {"Delta",DOUBLE,{100},FORBID} ,
   {" ",PREMIA_NULLTYPE,{0},FORBID}},
  CHK_OPT(CF_CarrMertonHeston),
  CHK_ok,
  MET(Init)
};
