...
int CALC(MC_AsianAlfonsi_Bates)(void *Opt, void *Mod, PricingMethod *Met)
{
  ...
  return MCAsianAlfonsiBates(ptMod->S0.Val.V_PDOUBLE,
...
static int CHK_OPT(MC_AsianAlfonsi_Bates)(void *Opt, void *Mod)
{
...
PricingMethod MET(MC_AsianAlfonsi_Bates)=
{
   "MC_Alfonsi_Asian_Bates",
