...
int FSelectModel(char InputFile[MAX_LINE][MAX_CHAR_LINE],int user,Planning *pt_plan,Model * *listmod,Model **mod);
int FSelectOption(char InputFile[MAX_LINE][MAX_CHAR_LINE],int user,Planning *pt_plan,Family **listopt,Model* pt_model,Pricing **pricing,Option **opt);

int FSelectPricing(char InputFile[MAX_LINE][MAX_CHAR_LINE],int user,Model *pt_model,Option *pt_option,Pricing **family,Pricing **result);
