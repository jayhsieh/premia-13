...
static doublereal c_b279 = .001;
static doublereal c_b280 = .9;
static doublereal c_b281 = .1;
static integer c__5 = 5;

/* Subroutine */ int inittask_(char *task, ftnlen task_len)
{
    /* Builtin functions */
...
/* Subroutine */ int inittask2_(char *task, ftnlen task_len)
{
    /* Builtin functions */
    /* Subroutine */ int s_copy(char *, char *, ftnlen, ftnlen);

    s_copy(task, "STOP: Maximum number of iterations reached", (ftnlen)60, (
	    ftnlen)42);
    return 0;
} /* inittask2_ */
...
/*        Check the input arguments for errors. */
	...
	if (s_cmp(task, "ERROR", (ftnlen)5, (ftnlen)5) == 0) {
	    prn3lb_(n, &x[1], f, task, iprint, &info, &itfile, &iter, &nfgv, &
		    nintol, &nskip, &nact, &sbgnrm, &c_b13, &nint, word, &
...
/*                               Line search is impossible. */
    ...
    dcsrch_(f, gd, stp, &c_b279, &c_b280, &c_b281, &c_b13, stpmx, csave, &
