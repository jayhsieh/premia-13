...
testProblem Rosenbrock={2,RosenStart,Rosen,RosenGrad,RosenSol};
...
testProblem Rosenbrock100={2,Rosen100Start,Rosen100,Rosen100Grad,Rosen100Sol};
...
testProblem Quadratic={2,QuadStart,Quad,QuadGrad,QuadSol};
...
testProblem Quadratic2={3,Quad2Start,Quad2,Quad2Grad,Quad2Sol};
...
testProblem WoodProblem={4,WoodStart,Wood,WoodGrad,WoodSol};
...
testProblem GaussProblem={30,GaussStart,Gauss,GaussGrad,GaussSol};
...
testProblem BigGaussProblem={1000,BigGaussStart,BigGauss,BigGaussGrad,BigGaussSol};
