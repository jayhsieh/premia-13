...
grid            *init_grid_cdo(const int    n,
                           const double     x[n])
{
  grid        *gd;
  int jn;
...
grid *init_hom_grid(const double     x0,
                    const double     xn,
                    const double     delta)
{
  grid        *gd;
...
step_fun        *init_constant_sf(const int size, const double *x,const double *y){
...
step_fun        *init_cont_linear_sf(const int size,const double   *x,const double *y){
  step_fun *sf = malloc(sizeof(step_fun));
  int jx;
